...
static const int64_t MAX_MONEY = 92000000000 * COIN; //92Bi
static const int64_t COIN_YEAR_REWARD = 62.5 * CENT; // 62,5% per year
static const int64_t MAX_MINT_PROOF_OF_STAKE = 0.625 * COIN;	// 62,5% annual interest
